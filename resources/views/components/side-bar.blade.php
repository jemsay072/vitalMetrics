<div class="flex flex-col">
    ...
    <nav class="flex justify-center flex-col text-white">
        ...
        <x-nav-link :href="route('bp')" class="pb-1 px-3 !py-4 !text-md text-slate-300 border-b-0 hover:bg-[#4c4c4c] hover:text-slate-100 focus:text-slate-100 active:bg-[#4c4c4c] gap-3" icon="fa-solid fa-fire">
            {{__('BP')}}
        </x-nav-link>
        <x-nav-link :href="route('weight')" class="pb-1 px-3 !py-4 !text-md text-slate-300 border-b-0 hover:bg-[#4c4c4c] hover:text-slate-100 focus:text-slate-100 active:bg-[#4c4c4c] gap-3" icon="fa-solid fa-fire">
            {{__('Weight Tracker')}}
        </x-nav-link>
    </nav>
</div>
